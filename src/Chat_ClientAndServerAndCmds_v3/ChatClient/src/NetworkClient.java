package Chat_ClientAndServerAndCmds_v3.ChatClient.src;


import Chat_ClientAndServerAndCmds_v3.ChatClient.src.client.controllers.AuthController;
...
public class NetworkClient extends Application {
    ...
    private void openAuthWindow() throws IOException {
        ...
        loader.setLocation(NetworkClient.class.getResource("client/views/auth-view.fxml"));
    ...
    public void createMainChatWindow() throws IOException {
        FXMLLoader loader = new FXMLLoader();
//        loader.setLocation(NetworkClient.class.getResource("views/server-view.fxml"));
        loader.setLocation(NetworkClient.class.getResource("client/views/chat-view.fxml"));
